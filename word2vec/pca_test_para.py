...
training_data = pickle.load(open('../largedata/text_training_data.pickle', 'rb'))
inverse_dict = {v: k for k,v in training_data.doc2id.items()}

plot_graph(inverse_dict, all_points, training_data.doc2id)
